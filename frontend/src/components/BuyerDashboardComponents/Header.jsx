...
import { IoMdSearch, IoMdCart, IoMdHeartEmpty, IoMdNotificationsOutline, IoMdList } from "react-icons/io";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-8">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link to="/buyer/orders" className="hidden sm:flex p-3 text-gray-400 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all" title="My Orders">
            ...
            <Link to="/buyer/profile" className="flex items-center gap-3 pl-2 group">
              <div className="hidden lg:block text-right">
                ...
                <p className="text-sm font-black text-gray-900 leading-none group-hover:text-green-600 transition-colors">{userInfo?.name || 'Guest User'}</p>
              </div>
              <div className="w-10 h-10 bg-gradient-to-br from-green-100 to-green-50 rounded-xl border border-green-200 flex items-center justify-center font-black text-green-700 shadow-sm group-hover:border-green-500 transition-all overflow-hidden">
