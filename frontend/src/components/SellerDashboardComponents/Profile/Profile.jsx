        ...
        <div className="bg-white rounded-2xl shadow-[0_2px_20px_rgba(0,0,0,0.04)] overflow-hidden border border-gray-100 max-w-4xl">
          ...
          <div className="pt-20 pb-10 px-10">
            <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-12">
              <div>
                <h1 className="text-3xl font-black text-gray-900 tracking-tighter uppercase">{formData.shopName || 'Your Shop'}</h1>
                <div className="flex items-center gap-3 mt-3">
                  <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 bg-gray-50 border border-gray-100 px-3 py-1 rounded-full">Managed by {formData.name}</span>
              ...
              >
                {isSaving ? 'Saving...' : (isEditing ? <><IoMdSave aria-hidden="true" className="text-xl" /> Save Profile</> : 'Edit Identity')}
              </button>
            </div>
